...
def _freecad_panel_agent_prompt(
    ...
    *,
    ...
    edit_contract = (
        ...
        "For a subtractive or replacement edit, prefer assigning the resulting Shape back to the "
        "existing target object. Do not leave the unchanged source solid visible underneath a new "
        "result object, because it will visually and geometrically mask cuts such as holes. If an "
        "in-place Shape update is impossible, remove the superseded source object after creating "
        "the result; do not rely only on ViewObject.Visibility, which may not persist in headless "
        "FCStd generation. "
